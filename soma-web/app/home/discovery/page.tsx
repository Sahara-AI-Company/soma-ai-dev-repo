...
import { Bell, Mail, Sun, Info, LayoutDashboard, ChevronLeftIcon, UserCircleIcon, Search, Compass } from "lucide-react";
...
const searchCategories = ["Publications", "Magazines", "Podcasts"];
            ...
            <header className="border-b bg-white fixed top-0 left-0 right-0 z-50 bg-background">
                <div className="flex items-center justify-between px-6 py-4 bg-background">
                    ...
                    {typeof window !== 'undefined' && window.innerWidth >= 768 ?
                        <div className="text-3xl font-semibold text-secondary">Discovery</div>
                        :
                            <div>
                    ...
                    <div className="w-full flex flex-col items-center justify-center">
                        ...
                        <div className="mb-6 flex flex-col items-center justify-center gap-2">
                            <h1 className={`font-bold mb-2
                                ...
                                `}>Discovery More Topics</h1>
                            <p className="text-primary text-center">
                                Discover different Publications, Magazines, and Podcasts Through Topics.
                            </p>
                        </div>

                        {/* Search Bar */}
                        <div className="relative mb-10 w-[100%] md:w-[80%] lg:w-[70%] xl:w-[60%] bg-background rounded-lg">
                            <MagnifyingGlassIcon className="absolute left-3 top-1/2 transform -translate-y-1/2 h-5 w-5 text-gray-400" />
                            <Input
                                type="text"
                                placeholder="Search..."
                        ...
                        <Tabs defaultValue="articles" className="w-full">
                            {!isAuthenticated ? (
                                <div className="flex-1 flex flex-col items-center justify-center gap-4 p-4 mt-6">
                                    <h3 className={`text-xl font-semibold text-center`}>Please Login to View Discovery</h3>
                                    <p className="text-sm text-gray-600 text-center">
                                        Create an account or login to discover different Creators, Publications, Magazines, and Podcasts.
                                    </p>
                                ...
                                <>
                                    ...
                                    <TabsContent value="articles" className="mt-6">
                                        ...
                                        <div className="p-5 flex flex-col items-center justify-center">
                                            <p className="text-lg text-gray-500 font-semibold mb-4 text-center">Recommended Articles Categories:</p>
                                            <p className="text-primary text-center">Article 1, Article 2, Article 3, Article 4, Article 5</p>
                                            <p className={`text-center text-green-500 flex flex-row items-center justify-center gap-2 ${width < 600 ? "text-xs" : "block"}`}>(Use <Info className="w-6 h-6" /> To Suggest New Categories To Help Us Improve)</p>
                                            <p className={`text-center text-green-500 flex flex-row items-center justify-center gap-2 ${width < 600 ? "text-xs" : "block"}`}>(Use <Plus className="w-6 h-6" /> To Add New Categories To Your Interests)</p>
                                        </div>
                                            ...
                                            {Object.entries(categories).map(([category, subcategories]) => (
                                                <Card key={category} className="hover:shadow-lg transition-shadow">
                                                    <CardHeader className="border-b border-gray-200 h-[30px] flex flex-row items-center justify-between">
                                                        ...
                                                        <div className="flex flex-row justify-center align-items"><Plus className="w-6 h-6 hover:cursor-pointer hover:bg-gray-300 rounded-sm" /></div>
                                                    </CardHeader>
                                                    <CardContent>
                                                        <div className="space-y-2">
                                                            {subcategories.slice(0, expandedCategories[category] ? subcategories.length : 5).map((subcategory, index) => (
                                                                <div key={index} className="flex items-center space-x-2 flex-row items-center justify-between">
                                                                    <span className="text-sm text-gray-600 hover:text-primary cursor-pointer underline">{subcategory}</span>
                                                                </div>
                                                            ))}
