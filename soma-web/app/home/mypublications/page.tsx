            ...
            <header className="border-b bg-white fixed top-0 left-0 right-0 z-50 bg-background">
                <div className="flex items-center justify-between px-6 py-4 bg-background">
                    ...
                    <div className="flex items-center gap-4">
                        ...
                        <div className="text-3xl font-semibold text-secondary">Publications</div>
                        :
                            ""
                        }
                    </div>
                        ...
                        <section className="rounded-lg m-2 w-full xl:w-[50%] xl:ml-[20%] bg-background p-2 sm:p-6 md:p-8 xl:p-10 overflow-y-auto">
                            ...
                            <Tabs defaultValue="activity" className="w-full">
                                <TabsList className="grid w-full grid-cols-4">
                                    <TabsTrigger value="activity" className="data-[state=active]:text-blue-600 dark:data-[state=active]:text-blue-600 data-[state=active]:bg-blue-50 dark:data-[state=active]:bg-blue-50">Publications</TabsTrigger>
                                    <TabsTrigger value="posts" className="data-[state=active]:text-blue-600 dark:data-[state=active]:text-blue-600 data-[state=active]:bg-blue-50 dark:data-[state=active]:bg-blue-50">Free Publications</TabsTrigger>
                                    <TabsTrigger value="likes" className="data-[state=active]:text-blue-600 dark:data-[state=active]:text-blue-600 data-[state=active]:bg-blue-50 dark:data-[state=active]:bg-blue-50">Monetized Publications</TabsTrigger>
                                    <TabsTrigger value="reads" className="data-[state=active]:text-blue-600 dark:data-[state=active]:text-blue-600 data-[state=active]:bg-blue-50 dark:data-[state=active]:bg-blue-50">Exculsive Publications</TabsTrigger>
                                </TabsList>
                                ...
                                <TabsContent value="posts" className="mt-4">
                                    <div className="space-y-4">
                                        <p>Saved Publications will be displayed here</p>
                                    </div>
                                </TabsContent>
