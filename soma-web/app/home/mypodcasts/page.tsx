                        ...
                        <section className="rounded-lg m-2 w-full xl:w-[50%] xl:ml-[20%] bg-background p-2 sm:p-6 md:p-8 xl:p-10 overflow-y-auto">
                            ...
                            <Tabs defaultValue="activity" className="w-full">
                                <TabsList className="grid w-full grid-cols-4">
                                    <TabsTrigger value="activity" className="data-[state=active]:text-blue-600 dark:data-[state=active]:text-blue-600 data-[state=active]:bg-blue-50 dark:data-[state=active]:bg-blue-50">Podcasts</TabsTrigger>
                                    <TabsTrigger value="posts" className="data-[state=active]:text-blue-600 dark:data-[state=active]:text-blue-600 data-[state=active]:bg-blue-50 dark:data-[state=active]:bg-blue-50">Free Podcasts</TabsTrigger>
                                    <TabsTrigger value="likes" className="data-[state=active]:text-blue-600 dark:data-[state=active]:text-blue-600 data-[state=active]:bg-blue-50 dark:data-[state=active]:bg-blue-50">Monetized Podcasts</TabsTrigger>
                                    <TabsTrigger value="reads" className="data-[state=active]:text-blue-600 dark:data-[state=active]:text-blue-600 data-[state=active]:bg-blue-50 dark:data-[state=active]:bg-blue-50">Exculsive Podcasts</TabsTrigger>
                                </TabsList>
                                <TabsContent value="activity" className="mt-4">
                                    <div className="space-y-4">
                                        <p>Your Podcasts will be displayed here</p>
                                    </div>
                                </TabsContent>
                                <TabsContent value="posts" className="mt-4">
                                    <div className="space-y-4">
                                        <p>Saved Podcasts will be displayed here</p>
                                    </div>
                                </TabsContent>
