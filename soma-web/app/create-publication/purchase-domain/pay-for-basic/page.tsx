...
export default function PayForBasicPage() {
        ...
        <div className="min-h-screen flex items-center justify-center bg-muted font-playfair-display py-8">
            <Card className="w-full max-w-md mx-auto">
                <CardHeader className="text-center">
                    <CardTitle className="text-2xl">Pay for Basic Subscription</CardTitle>
                    <CardDescription>
                        Unlock Basic for <span className="font-bold text-primary">$9.99/month</span>
                    </CardDescription>
                </CardHeader>
                <CardContent>
                    <form onSubmit={handleSubmit} className="space-y-6">
                        ...
                        {success && <div className="text-green-600 text-sm text-center">Payment successful! Welcome to Basic.</div>}
