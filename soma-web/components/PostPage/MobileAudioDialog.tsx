...
const ArticleAudioDialog = ({ 
    ...
    return (
        <Dialog open={open} onOpenChange={onOpenChange}>
            <DialogContent className="font-playfair-display w-[300px] rounded-lg">
                <DialogHeader>
                    ...
                    <TabsContent value="upload">
                        <form onSubmit={handleUpload}>
                            ...
                            <DialogFooter>
                                ...
                                <Button type="submit" disabled={!selectedFile} className="mb-2 bg-secondary text-white hover:bg-secondary/80">
                                    Insert Audio
                                </Button>
                            </DialogFooter>
                        </form>
                    ...
                    <TabsContent value="generate">
                        <form onSubmit={handleUpload}>
                            ...
                            <DialogFooter>
                                ...
                                <Button type="submit" className="mb-2 bg-secondary text-white hover:bg-secondary/80">
                                    Generate
                                </Button>
                            </DialogFooter>
                        </form>
