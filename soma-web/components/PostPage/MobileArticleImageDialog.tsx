            ...
            <DialogContent className="font-playfair-display rounded-lg w-[300px]">
                ...
                <Tabs value={activeTab} onValueChange={setActiveTab}>
                    <TabsList className="grid w-full grid-cols-3">
                        ...
                        <TabsTrigger value="generate">Gen <img src="/sparkles2.png" alt="Sparkles" className="w-5 h-5 cursor-pointer rounded-sm hover:bg-muted" /></TabsTrigger>
                    </TabsList>
                    ...
                    <TabsContent value="upload">
                        <form onSubmit={handleFileUpload}>
                            ...
                            <DialogFooter>
                                ...
                                <Button type="submit" disabled={!selectedFile} className="bg-secondary text-white hover:bg-secondary/80 mb-2">
                                    Upload Image
                                </Button>
                            </DialogFooter>
                        </form>
