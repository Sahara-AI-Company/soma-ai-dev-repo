...
// Publication Categories Component
interface PublicationCategoriesProps {
    ...
    return (
        ...
        <div className="relative">
            ...
            <div className="flex flex-row justify-between mb-1 pr-7">
                ...
                <label htmlFor="category" className="block text-lg font-bold text-primary mb-1 font-playfair-display">
                    Publication Categories <span className="text-xs text-gray-500">(suggest more categories for us <Dialog>
            ...
            <div className="flex items-center">
                <Input
                    ...
                    placeholder="Search Publication Category"
