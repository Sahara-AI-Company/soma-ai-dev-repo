        ...
        <div className={cn("flex flex-col gap-6", className)} {...props}>
            <Card>
                ...
                <CardHeader className="text-center">
                    <CardTitle className="text-3xl font-bold font-playfair-display ">Welcome!</CardTitle>
                    <CardDescription>
                    ...
                    <form onSubmit={handleLoginSubmit}>
                        <div className="grid gap-6">
                            <div className="flex flex-col gap-4">
                                ...
                                >
                                    <Button
                                        className="w-full bg-white cursor-pointer border border-gray-200 hover:bg-blue-50 hover:border-1 hover:border-blue-50 text-primary flex items-center justify-center gap-2"
                                        disabled={isLoading}
                                        type="button"
                                        size="lg"
                                    >
                                        ...
                                        <span style={{ fontFamily: 'Roboto, Arial, sans-serif', fontWeight: 500 }} className="text-gray-800">Sign in with Facebook</span>
                                    </Button>
                                </FacebookLogin>
                                ...
                                <div className="grid gap-2">
                                    <div className="flex items-center">
                                        ...
                                        <Link
                                            ...
                                            className="ml-auto text-sm underline underline-offset-4 text-2xl font-bold"
                                        >
                            ...
                            <div className="text-center text-sm">
                                ...
                                <Link href="/authentication/signup" className="underline underline-offset-4">
                                    Sign Up
                                </Link>
                            </div>
                        </div>
